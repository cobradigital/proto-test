...
type BooksServiceClient interface {
	GetBooksList(ctx context.Context, in *BooksRequest, opts ...grpc.CallOption) (*BooksResponse, error)
}
...
func (c *booksServiceClient) GetBooksList(ctx context.Context, in *BooksRequest, opts ...grpc.CallOption) (*BooksResponse, error) {
	out := new(BooksResponse)
	err := c.cc.Invoke(ctx, "/books.BooksService/GetBooksList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BooksServiceServer interface {
	GetBooksList(context.Context, *BooksRequest) (*BooksResponse, error)
...
func (UnimplementedBooksServiceServer) GetBooksList(context.Context, *BooksRequest) (*BooksResponse, error) {
...
func _BooksService_GetBooksList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BooksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BooksServiceServer).GetBooksList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/books.BooksService/GetBooksList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BooksServiceServer).GetBooksList(ctx, req.(*BooksRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _BooksService_GetBooksList_Handler,
		},
	},
