...
var (
	filter_TransactionsService_GetTransaction_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_TransactionsService_GetTransaction_0(ctx context.Context, marshaler runtime.Marshaler, client TransactionsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TransactionsService_GetTransaction_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterTransactionsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransactionsServiceServer) error {
	...
	mux.Handle("GET", pattern_TransactionsService_GetTransaction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/transactions.TransactionsService/GetTransaction", runtime.WithHTTPPathPattern("/api/transaction"))
		if err != nil {
...
func RegisterTransactionsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransactionsServiceClient) error {
	...
	mux.Handle("GET", pattern_TransactionsService_GetTransaction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/transactions.TransactionsService/GetTransaction", runtime.WithHTTPPathPattern("/api/transaction"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_TransactionsService_GetTransaction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "transaction"}, ""))
)
